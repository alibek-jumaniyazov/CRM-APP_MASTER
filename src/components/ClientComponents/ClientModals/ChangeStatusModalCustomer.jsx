...
export default function ChangeStatusModalCustomer({ ChangeStatus, setChangeStatus, getActive, dropClient }) {
        ...
        <div className="ChangeStatusModalInfo">
          ...
          <Select
            ...
            options={[
              {
                value: "Yangi Lead",
                label: <div className="statusWidth">Yangi Lead</div>,
              },
              {
                value: "contacted",
                label: (
