...
export default function ClientCustomerSendSmsModal({
  sendSms,
  SetsendSms,
}) {
    ...
    <div className="">
      ...
      <div className={sendSms ? "SendSmsGroup" : "hidden"}>
        ...
        <div className="SendSmsTexts">
          <p> {currentDiv === "div1" ? "Send new sms" : currentDiv === "div2" ? "Send sms from template" : "Sms history"}</p>
          <span>Send new sms to customer</span>
        </div>
