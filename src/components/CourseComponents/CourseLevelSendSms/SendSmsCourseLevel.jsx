...
function SendSmsCourseLevel({sendSms , SetsendSms, OpenSendQuestFun}) {
  ...
  return (
    <div className={sendSms ? "SendSmsCourse" : "hidden"}>
      ...
      <div className="SendSmsTexts">
        <p>Send sms to all levels</p>
        <span>Send sms students of all levels course</span>
      </div>
...
export default SendSmsCourseLevel;
