...
export default function FinanceAddBonus({ personalAddSalaryState, setPersonalAddSalary }) {
    ...
    <>
      <div className={personalAddSalaryState ? "PosationModal AddSalaryModal NewCustomerModal" : "hidden"}>
        ...
        <div className="NewCustomerModalTitles">
          <p>Add bonus for employee</p>
          <span>When the bonus is added, this amount is added to <br />the total earned amounts of employee </span>
        </div>
      ...
      >
        ...
        <div className="ConFimModalAddStudTitle ">
          ...
          <p>
            Continue adding bonus to the system without
            <br /> printing a check ?
          </p>
      ...
      <div className={SalaryModalSecond ? "LastConFimModalAddStud PosationModal" : "none"}>
        ...
        <div className="LastConFimModalAddStudTitle">
          <h2>Bonus added</h2>
          <p>Employee’s bonus have been added to the system</p>
        </div>
      </div>
    </>
  );
