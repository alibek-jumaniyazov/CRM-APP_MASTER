...
export default function FinanceAddRefoud({ personalAddSalaryState, setPersonalAddSalary }) {
    ...
    <>
      <div className={personalAddSalaryState ? "PosationModal AddSalaryModal NewCustomerModal" : "hidden"}>
        ...
        <div className="NewCustomerModalTitles">
          <p>Add refund</p>
          <span>If you add a refund, the amount will be completely <br /> withdrawn from the system</span>
        </div>
      ...
      >
        ...
        <div className="ConFimModalAddStudTitle ">
          <h2>Add refund without a check ?</h2>
          <p>
          Continue adding refund to the system
