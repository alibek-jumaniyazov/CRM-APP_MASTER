...
export default function FinanceAddSalary({ personalAddSalaryState, setPersonalAddSalary }) {
    ...
    <>
      <div className={personalAddSalaryState ? "PosationModal AddSalaryModal NewCustomerModal" : "hidden"}>
        ...
        <div className="NewCustomerModalTitles">
          <p>Add a salary</p>
          <span>Add a salary for the employee</span>
        </div>
      ...
      >
        ...
        <div className="ConFimModalAddStudTitle ">
          <h2>Add salary without a check ?</h2>
          <p>
          Continue adding salary to the system without 
            <br /> printing a check ?
          </p>
      ...
      <div className={SalaryModalSecond ? "LastConFimModalAddStud PosationModal" : "none"}>
        ...
        <div className="LastConFimModalAddStudTitle">
          <h2>Salary added</h2>
          <p>Salary have been added to the system</p>
        </div>
      </div>
    </>
  );
