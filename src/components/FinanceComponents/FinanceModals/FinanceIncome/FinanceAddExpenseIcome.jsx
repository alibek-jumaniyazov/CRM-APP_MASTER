...
export default function FinanceAddExpenseIcome({ personalAddSalaryState, setPersonalAddSalary }) {
    ...
    <>
      <div className={personalAddSalaryState ? "PosationModal AddSalaryModal NewCustomerModal" : "hidden"}>
        ...
        <div className="NewCustomerModalTitles">
          <p>Add expense for student</p>
          <span>If you add an expense, it will be deducted from the student's balance <br /> the fee will be added to the system as a benefit, and</span>
        </div>
        ...
        <div className="AddSalaryModalBalance">
          <div className="addSalaryBalance">
            <div className="AddSalaryModalBalanceInfoText">
              <p>Current balance:</p>
              <span style={{ color: "#2ED47A" }}>557 000 so’m</span>
            </div>
            {/* <div className="AddSalaryModalBalanceInfoText">
      ...
      <div className={SalaryModalSecond ? "LastConFimModalAddStud PosationModal" : "none"}>
        ...
        <div className="LastConFimModalAddStudTitle">
          <h2>Expense added</h2>
          <p>Student’s expense have been added to the system</p>
        </div>
      </div>
    </>
  );
